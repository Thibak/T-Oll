...
%let dirURI = Z:\AC\OLL-2009\cur_base\; * директория с базой;
...
Libname &LN "Z:\AC\OLL-2009\SAS"; * создали файл данных;
filename tranfile "Z:\AC\OLL-2009\REG_ARCH_&sysdate9..stc"; * условный идентификатор транспортного файла;
